    ...
    freeContent: {
      ...
      sections: [
        ...
        },
        {
          ...
          body:
            '波動拳を「削り」や「ヒット狙い」として撃っている限り、立ち回りは決して安定しません。\n\n波動拳の本質は、**「この状況で、あなたは何をしますか？」**という質問を相手に投げかける行為にあります。\n\n波動拳という質問に対する相手の回答は、ほぼ以下の3つに集約されます。\n\n・ジャンプする\n・ガードする\n・パリィする\n\nそして何より重要なのは、**「相手の回答を確認したうえで、こちらの次の行動を固定する」**ことです。\n\n・**【ジャンプする】**で返してきた相手\n→ 次はあえて波動拳を撃たず、**対空（昇龍拳）を一点待ち**して大ダメージを取ります。\n\n・**【ガードする】**を選んできた相手\n→ 相手は警戒心が最も高い状態です。前進や技振りにブレーキがかかっているため、**次の波動拳の継続**が極めて安全に通ります。\n\n・**【パリィする】**を選んできた相手\n→ Dゲージを減らしたくない心理が働いています。**波掌撃フェイント**や**前歩き投げ**の展開が劇的に通りやすくなります。',
        },
        {
          title: '3. 中距離でリュウが強い「本当の理由」',
          body:
            'リュウの中距離戦は、数値的に見ても非常に扱いやすく設計されています。\n\n・一歩踏み込んで**立ち強P（前大P）**で大きなプレッシャーをかけられる\n・波動拳の全体硬直が少なく、隙を晒しにくい\n・**しゃがみ強K（大足）**が発生9Fと早く、差し返しに使いやすい\n・相手が後退を選べば、安全に**「電刃錬気」**を溜められる\n\n→ 結果として、相手は**中距離戦に付き合わざるを得ない状況**に追い込まれます。\n\nただし、ここで勘違いしてはいけない決定的なポイントがあります。\n\nリュウ自身の技性能が単体でズバ抜けているから強いのではありません。\n**「相手が波動拳を警戒せざるを得ない距離だからこそ強い」**のです。\n\n相手は「前に出る」「技を振る」の両方にブレーキがかかり、焦って間合いの外で技を空振りしやすくなります。**差し返しは反射神経ではなく、相手が技を振らざるを得ない状況を作ることで成立する**のです。',
        },
        {
        ...
        },
        {
          ...
          body:
            'ここで、勝率が伸び悩むリュウ使いが陥りがちな典型的な3大NG行動を整理してみましょう。\n\n1. **目的のない波動拳を何となく撃ちすぎてしまう**\n2. **相手のすべての技を差し返そうと狙いすぎてしまう**\n3. **相手のあらゆる動きを見てから反応しようとしすぎてしまう**\n\nこれらはすべて、**「対戦中に自分が処理する判断を無駄に増やしてしまう行為」**です。\n\nリュウの強みである「判断を減らす」という設計思想とは真逆の方向に進んでしまっているため、まずはこれらを徹底して捨てることが脱・中級者への第一歩となります。',
        },
        {
