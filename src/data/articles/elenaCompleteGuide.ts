...
export const ELENA_COMPLETE_GUIDE: Article = {
  ...
  summary:
    'エレナの立ち回り・起き攻め・厳選コンボを徹底解説。リーチの長い牽制技を活かした地上戦、コロ・コロコロを活用したノーゲージ起き攻めと弾抜け、SA2（ヒーリング）の高回転運用からフレーム別の起き攻め、実戦コンボまで完全網羅。クラシック（C）・モダン（M）両対応で、ワンクリックで操作タイプを切り替えて閲覧できます。',
  game: 'sf6',
  category: 'character',
  character: 'エレナ',
