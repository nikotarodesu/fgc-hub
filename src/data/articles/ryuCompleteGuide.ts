...
export const RYU_COMPLETE_GUIDE: Article = {
  ...
  title: 'リュウ完全攻略｜クラシック・モダン対応',
  summary:
    'リュウの立ち回り・起き攻め・厳選コンボを徹底解説。通勤・通学の隙間時間に「読んで強くなる」をコンセプトに、クラシック（C）・モダン（M）双方の基本方針、主要な有利フレーム別の起き攻め、画面中央・画面端の実戦厳選コンボ、確定反撃、BO時削り連携まで整理。ワンクリックで操作タイプを切り替えて閲覧できます。',
  game: 'sf6',
  category: 'character',
  character: 'リュウ',
